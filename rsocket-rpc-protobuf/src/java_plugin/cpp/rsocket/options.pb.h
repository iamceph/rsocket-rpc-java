...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2frsocket_2foptions_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2frsocket_2foptions_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_proto_2frsocket_2foptions_2eproto
...
struct TableStruct_proto_2frsocket_2foptions_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2frsocket_2foptions_2eproto;
namespace io {
namespace rsocket {
namespace rpc {
...
class RSocketMethodOptions final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:io.rsocket.rpc.RSocketMethodOptions) */ {
 public:
  inline RSocketMethodOptions() : RSocketMethodOptions(nullptr) {}
  ~RSocketMethodOptions() override;
  explicit PROTOBUF_CONSTEXPR RSocketMethodOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(RSocketMethodOptions* other) {
    if (other == this) return;
  ...
  RSocketMethodOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit RSocketMethodOptions(::PROTOBUF_NAMESPACE_ID::Arena* arena,
 ...
 private:
  ...
  friend struct ::TableStruct_proto_2frsocket_2foptions_2eproto;
};
// ===================================================================
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2frsocket_2foptions_2eproto
